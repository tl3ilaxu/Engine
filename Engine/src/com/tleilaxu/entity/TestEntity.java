...
public class TestEntity extends Entity {
	...
	public void render(Screen screen) {
		// filter.apply();
		screen.drawImage(getX(), getY(), red);
		screen.drawImage(getX() + 300, getY(), green);
		screen.drawImage(getX() + 600, getY(), blue);
		screen.drawImage(getX(), getY() + 100, image);
		screen.drawImage(getX() + 300, getY() + 150, ImageEditor.blendImages(red, blue, green));
